...
model = project.version(4, local="http://localhost:###/").model
...
while True:
 ...
 if best_confidence > min_confidence :
  ...
  sendmail('###.###@gmail.com', alert_msg, f'Predicition: {str(prediction)}', new_file)
 ...
 sendmail('###.###@gmail.com', f'Goosebuster {today} EOD Summary', summary)
 events_today = {}
 random_events_today = []
 snooze_active = SNOOZE_MAX_COUNT
 START_TIME,STOP_TIME = GetSunRiseTime ()
